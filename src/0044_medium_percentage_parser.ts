...
type PercentageParser<
  Str extends string,
  ParsedSign = "",
  ParsedNumber extends string = "",
  ParsedPercentage = ""
> = Str extends `${infer First}${infer Rest}`
  ? First extends "+" | "-"
    ? PercentageParser<Rest, First, ParsedNumber, ParsedPercentage>
    : First extends "%"
    ? PercentageParser<Rest, ParsedSign, ParsedNumber, First>
    : PercentageParser<
        Rest,
        ParsedSign,
        `${ParsedNumber}${First}`,
        ParsedPercentage
      >
  : [ParsedSign, ParsedNumber, ParsedPercentage];
